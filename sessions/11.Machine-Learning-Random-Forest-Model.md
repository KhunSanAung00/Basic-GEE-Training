...
// ------------------------------------------------------
// Random Forest model information and band importance
// ------------------------------------------------------
...
3. 50% Threshold applied to the RF probability layer. Change the threshold to 60% or 70%. Depending on the result, user have control over the result & the output binary map.
